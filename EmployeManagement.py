...
def search_command():
    ...
    for row in data.search(firstname_text.get(),lastname_text.get(),mobile_text.get(),email_text.get(),experience_text.get(),salary_text.get(),address_text.get()):
        list1.insert(END,row)
def add_command():
    EmployeDB.insert(firstname_text.get(),lastname_text.get(),mobile_text.get(),email_text.get(),experience_text.get(),salary_text.get(),address_text.get())
    list1.delete(0,END)   
...
def update_command():
    EmployeDB.update(selected_tuple[0],firstname_text.get(),lastname_text.get(),mobile_text.get(),email_text.get(),experience_text.get(),salary_text.get(),address_text.get())
